...
public partial class OilPaintingArt2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.OilPaintingArtId).HasName("PK__OilPaint__708184D8185F42AD");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B440A75CF8");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA58679BCCA37");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D33708A8ABD").IsUnique();
